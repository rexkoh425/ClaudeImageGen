...
- `quality-report.json`: first-stop readiness report for Claude Code, combining prompt alignment, caption alignment, continuity, reference alignment, candidate recommendation, and concrete `next_actions`.
