...
- `quality-report.json`: first-stop readiness report for Claude Code, combining prompt alignment, caption alignment, continuity, reference alignment, candidate recommendation, refine-run `refinement_delta`, parent-child `visual_comparison`, failed checklist items from Claude vision, and concrete `next_actions`.
