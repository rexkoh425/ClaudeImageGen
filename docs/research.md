...
4. Caption-backchecking with local heuristics or a BLIP-style image captioner so Claude can compare what the generated image appears to contain against the requested prompt.
